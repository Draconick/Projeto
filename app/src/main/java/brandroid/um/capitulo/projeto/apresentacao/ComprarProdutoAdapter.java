 ...
 */
public class ComprarProdutoAdapter extends BaseAdapter {
    private Context context;
    private List<Produto> listaProdutos;
    private LayoutInflater inflater;

    public ComprarProdutoAdapter(Context context, List<Produto> listaProdutos){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view = inflater.inflate(R.layout.compra_item_list, null);
        ...
        TextView textUnidadesCompradas = (TextView) view.findViewById(R.id.unidades_compradas_lista);
        textUnidadesCompradas.setText(""+produto.getUnidadesCompradas());
